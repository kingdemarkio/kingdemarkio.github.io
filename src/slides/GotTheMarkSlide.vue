<template>
    <section class="w-full h-screen relative">
        ...
        <div class="absolute top-0 left-0 -z-30 w-full h-screen flex justify-between brightness-50 blur-xs">
            <img src="/assets/style/covid-left.png" alt="" class="h-full absolute left-0 top-0">
            <img src="/assets/style/covid-right.png" alt="" class="h-full absolute right-0 top-0">
        </div>
        <div class="w-full h-full relative drop-shadow-2xl drop-shadow-black">
            <div class="absolute top-0 left-0 p-16 text-left">
                <h1 class="text-4xl sm:text-6xl font-black">Got The Mark?</h1>
                <h2 class="text-xl sm:text-3xl font-black">That's a Good Sheep.</h2>                
            </div>
            <div class="absolute bottom-16 sm:bottom-0 right-0 p-16 text-right">
                <h1 class="text-3xl sm:text-6xl font-black">Modify Your DNA</h1>
                <h2 class="text-xl sm:text-3xl font-black">Scared Of Death?</h2>
            </div>
        </div>
    </section>
</template>